...
<head>
    ...
    <link rel="stylesheet" href="../../../filingua/lessons/tagalog/css/aralin5.css">
...
<body>
    ...
    <div class="greetings"> 
        <!-- Audio element -->
        <audio id="audio1" src="../../../filingua/lessons/tagalog/recordings/1/1.wav"></audio>
        <audio id="audio2" src="../../../filingua/lessons/tagalog/recordings/1/2.wav"></audio>
        <audio id="audio3" src="../../../filingua/lessons/tagalog/recordings/1/3.wav"></audio>
        <audio id="audio4" src="../../../filingua/lessons/tagalog/recordings/1/4.wav"></audio>
        <audio id="audio5" src="../../../filingua/lessons/tagalog/recordings/1/5.wav"></audio>
        <audio id="audio6" src="../../../filingua/lessons/tagalog/recordings/1/6.wav"></audio>
        <audio id="audio7" src="../../../filingua/lessons/tagalog/recordings/1/7.wav"></audio>
