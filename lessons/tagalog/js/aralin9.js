...
function third(element) {
  if (element.textContent === "3.  Ano'ng oras ang biyahe?") {
    ...
    element.textContent = "3.  Ano'ng oras ang biyahe?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function fifth(element) {
  if (element.textContent === "5. Mayroon bang taxi dito?") {
    ...
    element.textContent = "5. Mayroon bang taxi dito?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function ninth(element) {
  if (element.textContent === "9. Ano'ng oras darating ang eroplano?") {
