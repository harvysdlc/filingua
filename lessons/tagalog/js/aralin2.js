...
function second(element) {
  if (element.textContent === "2. Ano ang pangalan mo?") {
    ...
    element.textContent = "2. Ano ang pangalan mo?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function third(element) {
  if (element.textContent === "3. Saan ka nakatira?") {
    ...
    element.textContent = "3. Saan ka nakatira?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function fourth(element) {
  if (element.textContent === "4. Saan ka nagtatrabaho?") {
    ...
    element.textContent = "4. Saan ka nagtatrabaho?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function fifth(element) {
  if (element.textContent === "5. Taga-saan ka?") {
    ...
    element.textContent = "5. Taga-saan ka?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function sixth(element) {
  if (element.textContent === "6. Ilang taon ka na?") {
    ...
    element.textContent = "6. Ilang taon ka na?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function eight(element) {
  if (element.textContent === "8. Kapatid ko si Pedro") {
    ...
    element.textContent = "8. Kapatid ko si Pedro";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function ninth(element) {
  if (element.textContent === "9. Kaibigan kita!") {
    ...
    element.textContent = "9. Kaibigan kita!";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function tenth(element) {
  if (element.textContent === "10. Masaya akong nakilala kita!") {
