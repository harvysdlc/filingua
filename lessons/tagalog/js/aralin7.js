...
function first(element) {
  if (element.textContent === "1. Pagkain") {
...
function third(element) {
  if (element.textContent === "3. Kain tayo!") {
    ...
    element.textContent = "3. Kain tayo!";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function fourth(element) {
  if (element.textContent === "4. Masarap ito!") {
    ...
    element.textContent = "4. Masarap ito!";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function fifth(element) {
  if (element.textContent === "5. Pwede bang makuha ang resibo?") {
    ...
    element.textContent = "5. Pwede bang makuha ang resibo?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function sixth(element) {
  if (element.textContent === "6. Gusto ko ng prutas") {
    ...
    element.textContent = "6. Gusto ko ng prutas!";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function seventh(element) {
  if (element.textContent === "7. Pabili ng kanin") {
    ...
    element.textContent = "7. Pabili ng kanin";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function eight(element) {
  if (element.textContent === "8. Magkano itong ulam?") {
    ...
    element.textContent = "8. Magkano itong ulam?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function ninth(element) {
  if (element.textContent === "9. Ano ang espesyal dito?") {
    ...
    element.textContent = "9. Ano ang espesyal dito?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function tenth(element) {
  if (element.textContent === "10. Anong ulam mo?") {
    ...
    element.textContent = "10. Anong ulam mo?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
