...
function third(element) {
  if (element.textContent === "3. Magkakan kita") {
    ...
    element.textContent = "3. Magkakan kita";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function fourth(element) {
  if (element.textContent === "4. Namit ini") {
    ...
    element.textContent = "4. Namit ini";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function fifth(element) {
  if (element.textContent === "5. Pwede bang makuha an resibo?") {
    ...
    element.textContent = "5. Pwede bang makuha an resibo?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function sixth(element) {
  if (element.textContent === "6. Gusto ko sin prutas") {
    ...
    element.textContent = "6. Gusto ko sin prutas";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function seventh(element) {
  if (element.textContent === "7. Pabakal nin kanin") {
    ...
    element.textContent = "7. Pabakal nin kanin";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function eight(element) {
  if (element.textContent === "8. Magkano ini na ulam?") {
    ...
    element.textContent = "8. Magkano ini na ulam?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function ninth(element) {
  if (element.textContent === "9. Ano an espesyal dyan?") {
    ...
    element.textContent = "9. Ano an espesyal dyan?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function tenth(element) {
  if (element.textContent === "10. Ano an imo na ulam?") {
    ...
    element.textContent = "10. Ano an imo na ulam?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function startPractice() {
  ...
  setTimeout(function () {
    window.location.href = "../../../../filingua/quiz/Bicolano7.php";
