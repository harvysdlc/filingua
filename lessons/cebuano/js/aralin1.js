...
function first(element) {
  if (element.textContent === "1. Maayong Adlaw!") {
    ...
    element.textContent = "1. Maayong Adlaw!";
...
function eight(element) {
  if (element.textContent === "8. Maayong Buntag!") {
    ...
    element.textContent = "8. Maayong Buntag!";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function ninth(element) {
  if (element.textContent === "9. Maayong Gabii!") {
    ...
    element.textContent = "9. Maayong Gabii!";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function tenth(element) {
  if (element.textContent === "10. Amping") {
