...
function fifth(element) {
  if (element.textContent === "5. Asa ang kasilyas?") {
    ...
    element.textContent = "5. Asa ang kasilyas?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function seventh(element) {
  if (element.textContent === "7. Unsa ngalan ani na kalsadaha?") {
    ...
    element.textContent = "7. Unsa ngalan ani na kalsadaha?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function ninth(element) {
  if (element.textContent === "9. Tagpila ni?") {
    ...
    element.textContent = "9. Tagpila ni?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
