...
function tenth(element) {
  if (element.textContent === "10. Napulo") {
...
function thirty(element) {
  if (element.textContent === "30. Katuloan") {
    ...
    element.textContent = "30. Katuloan";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function fourty(element) {
  if (element.textContent === "40. Kaupatan") {
    ...
    element.textContent = "40. Kaupatan";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function fifty(element) {
  if (element.textContent === "50. Kalimaan") {
    ...
    element.textContent = "50. Kalimaan";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function sixty(element) {
  if (element.textContent === "60. Kaunoman") {
    ...
    element.textContent = "60. Kaunoman";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function seventy(element) {
  if (element.textContent === "70. Kapitoan") {
    ...
    element.textContent = "70. Kapitoan";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function eighty(element) {
  if (element.textContent === "80. Kawaloan") {
    ...
    element.textContent = "80. Kawaloan";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function ninety(element) {
  if (element.textContent === "90. Kasiyaman") {
    ...
    element.textContent = "90. Kasiyaman";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function onehundred(element) {
  if (element.textContent === "100. Usa ka gatos") {
    ...
    element.textContent = "100. Usa ka gatos";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
