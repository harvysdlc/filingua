...
<body>
    ...
    <div class="greetings"> 
        <!-- Audio element -->
        <audio id="audio1" src="../../../filingua/lessons/cebuano/recordings/6/1.wav"></audio>
        <audio id="audio2" src="../../../filingua/lessons/cebuano/recordings/6/2.wav"></audio>
        <audio id="audio3" src="../../../filingua/lessons/cebuano/recordings/6/3.wav"></audio>
        <audio id="audio4" src="../../../filingua/lessons/cebuano/recordings/6/4.wav"></audio>
        <audio id="audio5" src="../../../filingua/lessons/cebuano/recordings/6/5.wav"></audio>
        <audio id="audio6" src="../../../filingua/lessons/cebuano/recordings/6/6.wav"></audio>
        <audio id="audio7" src="../../../filingua/lessons/cebuano/recordings/6/7.wav"></audio>
        <audio id="audio8" src="../../../filingua/lessons/cebuano/recordings/6/8.wav"></audio>
        <audio id="audio9" src="../../../filingua/lessons/cebuano/recordings/6/9.wav"></audio>
        <audio id="audio10" src="../../../filingua/lessons/cebuano/recordings/6/10.wav"></audio>
        ...
        <p>Pindutin ang salita o parirala upang makita ang pagsasalin<br>
            ...
            <span style="font-size: small; font-weight: bold"> Halimbawa: Nagdunggab ang sakyanan sa bahin sa kanan sa karsada.</span><br>
            ...
            <br><br>
            <span onclick="second(this)">2. Wala</span>
            ...
            <span style="font-size: small; font-weight: bold"> Halimbawa: Nikasud sa wala ang mga motorsiklo nga anaa sa atubangan sa among sakyanan.</span><br>
            ...
            <span style="font-size: small; font-weight: bold"> Halimbawa: Gipatawag ni Ma'am Juana si Nelia sa atubang sa entablado.</span><br>
            ...
            <span style="font-size: small; font-weight: bold"> Halimbawa: Ang bag-ong building sa likod sa eskwelahan kay sakop sa pagpanag-iya ni Don Guevarra.</span><br>
            ...
            <span style="font-size: small; font-weight: smaller; color: #bbb;">___________________________________________________________________________________________________________</span>
            <br><br>
            <span onclick="fifth(this)">5. Diri</span>
            ...
            <span style="font-size: small; font-weight: bold"> Halimbawa: Diri sa Cavite naghalin si Emilio Aguinaldo.</span><br>
            <span style="font-size: small; font-weight: normal; color: #3F3931;">In, at, or to this place or position.</span><br><br>
            <span style="font-size: small; font-weight: smaller; color: #bbb;">___________________________________________________________________________________________________________</span>
            <br><br>
            <span onclick="sixth(this)">6. Dinha</span>
            ...
            <span style="font-size: small; font-weight: bold"> Halimbawa: Celia, palihug kuhaa ang akong payong dinha sa may lalagyanan. </span><br>
            ...
            <span style="font-size: small; font-weight: bold"> Halimbawa: Gipasang-at ni Aling Puring si Gwen nga itaas ang iyang iring sa ikaduhang andana sa balay.</span><br>
            ...
            <span style="font-size: small; font-weight: bold"> Halimbawa: Nakakalula kada kahigayonan nga magtan-aw ka sa ubos gikan sa itaas nga mataas nga balay.</span><br>
            ...
            <span style="font-size: small; font-weight: bold"> Halimbawa: Ipinagbilin ni Inay nga diretsuha lang nato kining karsada padulong sa San Isidro.</span><br>
            ...
            <span style="font-size: small; font-weight: bold"> Halimbawa: Sa kilid sa akong katre ang mahalon nga lamesita.</span><br>
