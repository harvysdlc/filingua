...
function first(element) {
  if (element.textContent === "1. Nukarin ing pauling terminal ng bus?") {
    ...
    element.textContent = "1. Nukarin ing pauling terminal ng bus?";
...
function second(element) {
  if (element.textContent === "2. Magkanu ing bayad pa-Manila?") {
    ...
    element.textContent = "2. Magkanu ing bayad pa-Manila?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function fourth(element) {
  if (element.textContent === "4. Nanu ing saken pa-Indang?") {
    ...
    element.textContent = "4. Nanu ing saken pa-Indang?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function fifth(element) {
  if (element.textContent === "5. Atyu bang taxi idi?") {
    ...
    element.textContent = "5. Atyu bang taxi idi?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function sixth(element) {
  if (element.textContent === "6. Nukarin mung paliparan?") {
    ...
    element.textContent = "6. Nukarin mung paliparan?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function seventh(element) {
  if (
    element.textContent === "7. Nukarin ing pinakamalapit a estasyun ning tren?"
  ) {
...
function ninth(element) {
  if (element.textContent === "9. Nanu ing oras ing eruplanu makaratang?") {
    ...
    element.textContent = "9. Nanu ing oras ing eruplanu makaratang?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function tenth(element) {
  if (element.textContent === "10. Makananu miras king bangku?") {
    ...
    element.textContent = "10. Makananu miras king bangku?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function startPractice() {
  ...
  setTimeout(function () {
    window.location.href = "../../../../filingua/quiz/Kapampangan9.php";
