...
function first(element) {
  if (element.textContent === "1. Mayap a abak!") {
    ...
    element.textContent = "1. Mayap a abak!";
...
function fourth(element) {
  if (element.textContent === "4. Ngeni ya mu") {
    ...
    element.textContent = "4. Ngeni ya mu";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function seventh(element) {
  if (element.textContent === "7. Ali/Aliwa") {
    ...
    element.textContent = "7. Ali/Aliwa";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function eight(element) {
  if (element.textContent === "8. Mayap a abak!") {
    ...
    element.textContent = "8. Mayap a abak!";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function ninth(element) {
  if (element.textContent === "9. Mayap a napun!") {
    ...
    element.textContent = "9. Mayap a napun!";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function tenth(element) {
  if (element.textContent === "10. Mingat ka/Mimingat ka") {
    ...
    element.textContent = "10. Mingat ka/Mimingat ka";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function startPractice() {
  ...
  setTimeout(function () {
    window.location.href = "../../../../filingua/quiz/Kapampangan1.php";
