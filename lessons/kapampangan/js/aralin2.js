...
function first(element) {
  if (element.textContent === "1. Aku pu Juan!") {
    ...
    element.textContent = "1. Aku pu Juan!";
...
function second(element) {
  if (element.textContent === "2. Nanu ing lagyu mu?") {
    ...
    element.textContent = "2. Nanu ing lagyu mu?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function third(element) {
  if (element.textContent === "3. Nukarin po ing kayang luguran?") {
    ...
    element.textContent = "3. Nukarin po ing kayang luguran?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function fourth(element) {
  if (element.textContent === "4. Nukarin la pung gawan?") {
    ...
    element.textContent = "4. Nukarin la pung gawan?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function fifth(element) {
  if (element.textContent === "5. Taga nukarin ka?") {
    ...
    element.textContent = "5. Taga nukarin ka?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function sixth(element) {
  if (element.textContent === "6. Nanu yang edad mu?") {
    ...
    element.textContent = "6. Nanu yang edad mu?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function eight(element) {
  if (element.textContent === "8. Kapatad ku pu si Pedro") {
    ...
    element.textContent = "8. Kapatad ku pu si Pedro";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function ninth(element) {
  if (element.textContent === "9. Kaluguran ku pu!") {
    ...
    element.textContent = "9. Kaluguran ku pu!";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function tenth(element) {
  if (element.textContent === "10. Malugud ku king pamagkulala mu!") {
    ...
    element.textContent = "10. Malugud ku king pamagkulala mu!";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function eleven(element) {
  if (
    element.textContent === "11. Aku pu king pamagaral king Unibersidad ning Pilipinas"
  ) {
    element.textContent =
...
function twelve(element) {
  if (
    element.textContent ===
    "12. Ing obra ku king pagkumpuni ning mabukung computer"
  ) {
...
function fourteen(element) {
  if (element.textContent === "14. Aku pu ing dili a estudiante") {
    ...
    element.textContent = "14. Aku pu ing dili a estudiante";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function fifteen(element) {
  if (element.textContent === "15. Asul ing favorite kung kulay") {
    ...
    element.textContent = "15. Asul ing favorite kung kulay";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function startPractice() {
  ...
  setTimeout(function () {
    window.location.href = "../../../../filingua/quiz/Kapampangan2.php";
