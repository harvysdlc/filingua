...
function second(element) {
  if (element.textContent === "2. Magkanu ya ini?") {
    ...
    element.textContent = "2. Magkanu ya ini?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function fifth(element) {
  if (element.textContent === "5. Puwede ku tumawad?") {
    ...
    element.textContent = "5. Puwede ku tumawad?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function sixth(element) {
  if (element.textContent === "6. Nukarin ing batas?") {
    ...
    element.textContent = "6. Nukarin ing batas?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function eight(element) {
  if (element.textContent === "8. Atyu bang diskuwento?") {
    ...
    element.textContent = "8. Atyu bang diskuwento?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function ninth(element) {
  if (element.textContent === "9. Nanung oras ilang magbukas ampong magsara?") {
    ...
    element.textContent = "9. Nanung oras ilang magbukas ampong magsara?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function tenth(element) {
  if (element.textContent === "10. Puwede bang gamitan ing credit card?") {
    ...
    element.textContent = "10. Puwede bang gamitan ing credit card?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function startPractice() {
  ...
  setTimeout(function () {
    window.location.href = "../../../../filingua/quiz/Kapampangan8.php";
