...
function third(element) {
  if (element.textContent === "3. E ku balu") {
    ...
    element.textContent = "3. E ku balu";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function fourth(element) {
  if (element.textContent === "4. Nanu ing oras na?") {
    ...
    element.textContent = "4. Nanu ing oras na?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function fifth(element) {
  if (element.textContent === "5. Nukarin ing banyu?") {
    ...
    element.textContent = "5. Nukarin ing banyu?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function sixth(element) {
  if (element.textContent === "6. Buri ku yang kapi") {
    ...
    element.textContent = "6. Buri ku yang kapi!";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function seventh(element) {
  if (element.textContent === "7. Nanu ing kewanan da kung lalawigan?") {
    ...
    element.textContent = "7. Nanu ing kewanan da kung lalawigan?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function eight(element) {
  if (element.textContent === "8. Atyu wifi karin?") {
    ...
    element.textContent = "8. Atyu wifi karin?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function ninth(element) {
  if (element.textContent === "9. Magkanu ya iya?") {
    ...
    element.textContent = "9. Magkanu ya iya?";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function tenth(element) {
  if (element.textContent === "10. Buri ke ini!") {
    ...
    element.textContent = "10. Buri ke ini!";
    element.style.color = "#ff914d";
    element.style.fontStyle = "normal";
    element.style.fontSize = "initial";
    element.style.fontWeight = "bold";
...
function startPractice() {
  ...
  setTimeout(function () {
    window.location.href = "../../../../filingua/quiz/Kapampangan4.php";
