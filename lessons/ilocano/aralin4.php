...
<body>
    ...
    <div class="greetings"> 
        <!-- Audio element -->
        <audio id="audio1" src="../../../filingua/lessons/ilocano/recordings/4/1.wav"></audio>
        <audio id="audio2" src="../../../filingua/lessons/ilocano/recordings/4/2.wav"></audio>
        <audio id="audio3" src="../../../filingua/lessons/ilocano/recordings/4/3.wav"></audio>
        <audio id="audio4" src="../../../filingua/lessons/ilocano/recordings/4/4.wav"></audio>
        <audio id="audio5" src="../../../filingua/lessons/ilocano/recordings/4/5.wav"></audio>
        <audio id="audio6" src="../../../filingua/lessons/ilocano/recordings/4/6.wav"></audio>
        <audio id="audio7" src="../../../filingua/lessons/ilocano/recordings/4/7.wav"></audio>
        <audio id="audio8" src="../../../filingua/lessons/ilocano/recordings/4/8.wav"></audio>
        <audio id="audio9" src="../../../filingua/lessons/ilocano/recordings/4/9.wav"></audio>
        <audio id="audio10" src="../../../filingua/lessons/ilocano/recordings/4/10.wav"></audio>
