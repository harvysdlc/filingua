...
<body>
    ...
    <div class="greetings"> 
        <!-- Audio element -->
        <audio id="audio1" src="../../../filingua/lessons/ilocano/recordings/8/1.wav"></audio>
        <audio id="audio2" src="../../../filingua/lessons/ilocano/recordings/8/2.wav"></audio>
        <audio id="audio3" src="../../../filingua/lessons/ilocano/recordings/8/3.wav"></audio>
        <audio id="audio4" src="../../../filingua/lessons/ilocano/recordings/8/4.wav"></audio>
        <audio id="audio5" src="../../../filingua/lessons/ilocano/recordings/8/5.wav"></audio>
        <audio id="audio6" src="../../../filingua/lessons/ilocano/recordings/8/6.wav"></audio>
        <audio id="audio7" src="../../../filingua/lessons/ilocano/recordings/8/7.wav"></audio>
        <audio id="audio8" src="../../../filingua/lessons/ilocano/recordings/8/8.wav"></audio>
        <audio id="audio9" src="../../../filingua/lessons/ilocano/recordings/8/9.wav"></audio>
        <audio id="audio10" src="../../../filingua/lessons/ilocano/recordings/8/10.wav"></audio>
        ...
        <p>Pindutin ang salita o parirala upang makita ang pagsasalin<br>
            ...
            <span style="font-size: small; font-weight: smaller; color: #bbb;">___________________________________________________________________________________________________________</span>
            <br><br>
            <span onclick="fourth(this)">4. Kayat ko dayta!</span>
            ...
            <span style="font-size: small; font-weight: normal; color: #3F3931;">/ Ka-yat ko day-ta! /</span><br><br>
            <span style="font-size: small; font-weight: bold"> Halimbawa: Kayatko daytoy  hamonado nga inted ni Aling Bebang.</span><br>
