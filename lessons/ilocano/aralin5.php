...
<head>
    ...
    <script src="../ilocano/js/aralin5.js" defer></script>
</head> 
<body>
    <div class="stage">
        <div class="label">
                <h2>Aralin 5: Aldaw ti Bulan</h2>
    ...
    <div class="greetings"> 
        <!-- Audio element -->
        <audio id="audio1" src="../../../filingua/lessons/ilocano/recordings/5/1.wav"></audio>
        <audio id="audio2" src="../../../filingua/lessons/ilocano/recordings/5/2.wav"></audio>
        <audio id="audio3" src="../../../filingua/lessons/ilocano/recordings/5/3.wav"></audio>
        <audio id="audio4" src="../../../filingua/lessons/ilocano/recordings/5/4.wav"></audio>
        <audio id="audio5" src="../../../filingua/lessons/ilocano/recordings/5/5.wav"></audio>
        <audio id="audio6" src="../../../filingua/lessons/ilocano/recordings/5/6.wav"></audio>
        <audio id="audio7" src="../../../filingua/lessons/ilocano/recordings/5/7.wav"></audio>
        <audio id="audio8" src="../../../filingua/lessons/ilocano/recordings/5/8.wav"></audio>
        <audio id="audio9" src="../../../filingua/lessons/ilocano/recordings/5/9.wav"></audio>
        <audio id="audio10" src="../../../filingua/lessons/ilocano/recordings/5/10.wav"></audio>
        <audio id="audio11" src="../../../filingua/lessons/ilocano/recordings/5/11.wav"></audio>
        <audio id="audio12" src="../../../filingua/lessons/ilocano/recordings/5/12.wav"></audio>
        <audio id="audio13" src="../../../filingua/lessons/ilocano/recordings/5/13.wav"></audio>
        <audio id="audio14" src="../../../filingua/lessons/ilocano/recordings/5/14.wav"></audio>
        <audio id="audio15" src="../../../filingua/lessons/ilocano/recordings/5/15.wav"></audio>
        <audio id="audio16" src="../../../filingua/lessons/ilocano/recordings/5/16.wav"></audio>
        <audio id="audio17" src="../../../filingua/lessons/ilocano/recordings/5/17.wav"></audio>
        <audio id="audio18" src="../../../filingua/lessons/ilocano/recordings/5/18.wav"></audio>
        <audio id="audio19" src="../../../filingua/lessons/ilocano/recordings/5/19.wav"></audio>
        <audio id="audio20" src="../../../filingua/lessons/ilocano/recordings/5/20.wav"></audio>
        <audio id="click" src="../../../filingua/audio/click.mp3"></audio>
    
        <!-- Text element -->
        <p>Pindutin ang salita o parirala upang makita ang pagsasalin<br>
            <span style="font-size: small; font-weight: normal; color: #3F3931;">Click the word or phrase to see translation</span><br><br><br>
            <span onclick="first(this)">1. Dominggo</span>
            ...
            <span style="font-size: small; font-weight: normal; color: #3F3931;">/ Do-ming-go /</span><br><br>
            <span style="font-size: small; font-weight: bold"> Halimbawa: Ti simbaan ket naragsak kada Dominggo.</span><br>
            ...
            <span style="font-size: small; font-weight: bold"> Halimbawa: Diay project mi ket deadline na ton Lunes.</span><br>
            ...
            <span style="font-size: small; font-weight: bold"> Halimbawa: Pumanaw ni Donna to sumaruno nga Martes.</span><br>
            ...
            <span style="font-size: small; font-weight: bold"> Halimbawa: Naibait ni Jojo ti payong na idi naminsan nga Miyerkules idiay library.</span><br>
            ...
            <span style="font-size: small; font-weight: bold"> Halimbawa: Huwebes idi nagsina kami ni Juan</span><br>
            ...
            <span style="font-size: small; font-weight: bold"> Halimbawa: Kaya’t ko talaga ti Biyernes, nasapa ngamin ti napagawid tayo.</span><br>
            ...
            <span style="font-size: small; font-weight: bold"> Halimbawa: Diay outing mi idiay Batangas ket ton umay nga Sabado.</span><br>
            ...
            <span style="font-size: small; font-weight: bold"> Halimbawa: Diay naudi nga panag usap mi ket idi sangapulo ket pito iti Enero, tawen duaribo ken sangapulo ken pito.</span><br>
            ...
            <span style="font-size: small; font-weight: bold"> Halimbawa: Dagiti tsokolate ken rosrosas ket alisto nga malako nu Pebrero.</span><br>
            ...
            <span style="font-size: small; font-weight: bold"> Halimbawa: Naggraduar kami idi Marso.</span><br>
            ...
            <span style="font-size: small; font-weight: bold"> Halimbawa: Namaris nga sabong ket agsabong nu Abril.</span><br>
            ...
            <span style="font-size: small; font-weight: bold"> Halimbawa: Ni Roland ket nabagyo idiay Mindoro idi mayka-tallo nga adlay iti bulan ti Mayo.</span><br>
            ...
            <span style="font-size: small; font-weight: bold"> Halimbawa: Napigasa nga init ti marikna ti dagiti Filipino nu malpas ti bulan ti Hunyo.</span><br>
            ...
            <span style="font-size: small; font-weight: bold"> Halimbawa: Agosto ti adda nga pinakaado nga piyesta idiay ili ti Quezon.</span><br>
            ...
            <span style="font-size: small; font-weight: bold"> Halimbawa: Ti aldaw nga panakayannak ni Auntie Jena ket ton maykatatllo nga aldaw iti Oktubre.</span><br>
            ...
            <span style="font-size: small; font-weight: bold"> Halimbawa: Agpakita dagiti ar–arya kada Nobyembre.</span><br>
            ...
            <span style="font-size: small; font-weight: bold"> Halimbawa: Makitak isuna inaldaw idiay likod ti balay mi.</span><br>
