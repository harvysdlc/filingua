...
<head>
    ...
    <title>Pagsasanay - Cebuano 2 </title>
...
<body>
    <div class="stage">
        <div class="label">
            <h2>Aralin 2: Mga Pagpapakilala</h2>
        </div>
        <div class="larrow">
    ...
    <div class="container">
        <form method="post">
            <div class="intro">
                <br>
                <p><b>Practice Cebuano</b></p>
                <p>Translate the following from cebuano to English and vice versa.</p>
            </div>
            <?php
            $questions = array();
            $lang_id = 3;
